...
@pytest.mark.parametrize(
    ...
    [
        # Valid Cases
        (4, 4, "Deuce"),  # Equal score, at least 4
        (3, 3, "Deuce"), 
        (9, 9, "Deuce"), 
        (6, 4, "Win for Player1"),  # Player1 wins with a 2-point difference
        (3, 5, "Win for Player2"),  # Player2 wins with a 2-point difference
        (4, 3, "Advantage for Player1"),  # Player1 has advantage
        (3, 4, "Advantage for Player2"),  # Player2 has advantage
        (3, 0, "Forty-Love"),
        (2, 1, "Thirty-Fifteen"),
        (1, 4, "Win for Player2"),
